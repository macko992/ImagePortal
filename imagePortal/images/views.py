...
def tag_list(request, tag_slug=None):
    tags_list = Image.tags.all()





    return render(request, 'images/image/tag_list.html',
                  {'tags_list': tags_list})
...
def tags(request, tag_slug=None):
    ...
    try:
        ...
        images = paginator.page(paginator.num_pages)
    return render(request, 'images/image/tag_detail.html',
                  {'section': 'tags',
                  'page': page,
                  'images': images,
                  'tag': tag})
...
#DO naprawy bo niedziałają lajki za bardzo
#@login_required
#def image_ranking_like(request):
...
#    if request.is_ajax():
#        return render(request,
#                      'images/image/liked_ajax.html',
#                      {'section': 'images',
#                       'images': images})
#    return render(request,
#                  'images/image/liked.html',
#                   {'section': 'images',
#                    'images': images})
